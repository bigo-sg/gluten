...
// This module is use to convert column vector to flink generic rows.
public abstract class ArrowVectorAccessor {
    public static ArrowVectorAccessor create(FieldVector vector) {
        if (vector instanceof BitVector) {
            ...
            throw new UnsupportedOperationException("ArrowVectorAccessor. Unsupported type: " + vector.getClass().getName());
        }
    }
