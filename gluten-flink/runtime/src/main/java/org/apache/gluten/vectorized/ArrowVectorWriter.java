...
public abstract class ArrowVectorWriter {
    ...
    protected static ArrowVectorWriter create(
        ...
        if (fieldType instanceof IntegerType) {
            return new IntVectorWriter(fieldName, fieldType, allocator, vector);
        } else if (fieldType instanceof BooleanType) {
            return new BooleanVectorWriter(fieldName, fieldType, allocator, vector);
        } else if (fieldType instanceof BigIntType) {
            return new BigIntVectorWriter(fieldName, fieldType, allocator, vector);
        } else if (fieldType instanceof VarCharType) {
            return new VarCharVectorWriter(fieldName, fieldType, allocator, vector);
        } else if (fieldType instanceof TimestampType) {
            return new TimestampVectorWriter(fieldName, fieldType, allocator, vector);
        } else if (fieldType instanceof RowType) {
            return new StructVectorWriter(fieldName, fieldType, allocator, vector);
        } else {
