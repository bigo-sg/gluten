...
class ScanTest extends GlutenStreamingTestBase {
    ...
    void testArrayScan() {
        List<Row> rows =
                Arrays.asList(Row.of(1, new Integer[]{1, 2, 3}),
        ...
        rows =
            Arrays.asList(Row.of(1, new String[]{"a", "b", "c"}),
        ...
        runAndCheck(query, Arrays.asList(
            "+I[1, [a, b, c]]",
            "+I[2, [d, e, f]]",
            "+I[3, [g, h, i]]"));
        ...
        rows =
            Arrays.asList(
                Row.of(1, new Row[]{Row.of(1,2), Row.of(3,4)}),
                Row.of(3, new Row[]{Row.of(5,6)}));
    ...
    void testMapScan() {
        List<Row> rows =
            Arrays.asList(Row.of(1,  Map.of(1, "a")),
