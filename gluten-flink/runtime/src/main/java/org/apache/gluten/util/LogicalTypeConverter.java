...
public class LogicalTypeConverter {
    ...
    private static Map<Class<?>, VLTypeConverter> converters = Map.ofEntries(
        Map.entry(BooleanType.class, logicalType -> new io.github.zhztheplayer.velox4j.type.BooleanType()),
        Map.entry(IntType.class, logicalType -> new io.github.zhztheplayer.velox4j.type.IntegerType()),
        Map.entry(BigIntType.class, logicalType -> new io.github.zhztheplayer.velox4j.type.BigIntType()),
        Map.entry(DoubleType.class, logicalType -> new io.github.zhztheplayer.velox4j.type.DoubleType()),
        Map.entry(VarCharType.class, logicalType -> new io.github.zhztheplayer.velox4j.type.VarCharType()),
        // TODO: may need precision
        Map.entry(TimestampType.class, logicalType -> new io.github.zhztheplayer.velox4j.type.TimestampType()),
        ...
        Map.entry(DayTimeIntervalType.class, logicalType -> new io.github.zhztheplayer.velox4j.type.BigIntType()),
